...
module EbayTrading # :nodoc:
  module Types # :nodoc:
    ...
    #  datetime_node :accepted_time, 'AcceptedTime', :optional => true
    #  datetime_node :seller_ebay_payment_process_enable_time, 'SellereBayPaymentProcessEnableTime', :optional => true
