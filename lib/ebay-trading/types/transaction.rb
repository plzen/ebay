...
require 'ebay-trading/types/item'
require 'ebay-trading/types/transaction_status'
require 'ebay-trading/types/external_transaction'
require 'ebay-trading/types/selling_manager_product_details'
require 'ebay-trading/types/shipping_service_options'
require 'ebay-trading/types/feedback_info'
require 'ebay-trading/types/order'
require 'ebay-trading/types/listing_checkout_redirect_preference'
require 'ebay-trading/types/refund'
require 'ebay-trading/types/variation'
require 'ebay-trading/types/taxes'
require 'ebay-trading/types/payment_hold_detail'
require 'ebay-trading/types/seller_discounts'
require 'ebay-trading/types/multi_leg_shipping_details'
require 'ebay-trading/types/unpaid_item'
require 'ebay-trading/types/payments_information'
require 'ebay-trading/types/pickup_options'
require 'ebay-trading/types/pickup_method_selected'
require 'ebay-trading/types/buyer_package_enclosure'
