require 'ebay-trading/types/store_logo'
require 'ebay-trading/types/store_theme'
require 'ebay-trading/types/store_custom_category'
require 'ebay-trading/types/store_custom_listing_header'
