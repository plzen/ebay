require 'ebay-trading/types/feedback_period'
require 'ebay-trading/types/average_rating_summary'
require 'ebay-trading/types/seller_role_metrics'
require 'ebay-trading/types/buyer_role_metrics'
