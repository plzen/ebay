...
require 'ebay-trading/types/scheduling_info'
require 'ebay-trading/types/pro_stores_checkout_preference'
require 'ebay-trading/types/charity_affiliation_detail'
require 'ebay-trading/types/feature_eligibility'
require 'ebay-trading/types/seller_ebay_payment_process_consent_code'
