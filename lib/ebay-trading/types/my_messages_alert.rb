require 'ebay-trading/types/my_messages_response_details'
require 'ebay-trading/types/my_messages_forward_details'
require 'ebay-trading/types/my_messages_folder'
