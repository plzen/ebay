require 'ebay-trading/types/attribute_set'
require 'ebay-trading/types/attribute'
require 'ebay-trading/types/lookup_attribute'
require 'ebay-trading/types/payment_details'
require 'ebay-trading/types/bidding_details'
require 'ebay-trading/types/charity'
require 'ebay-trading/types/cross_promotions'
require 'ebay-trading/types/distance'
require 'ebay-trading/types/listing_details'
require 'ebay-trading/types/listing_designer'
require 'ebay-trading/types/category'
require 'ebay-trading/types/product_listing_details'
require 'ebay-trading/types/revise_status'
require 'ebay-trading/types/user'
require 'ebay-trading/types/selling_status'
require 'ebay-trading/types/shipping_details'
require 'ebay-trading/types/storefront'
require 'ebay-trading/types/vat_details'
require 'ebay-trading/types/best_offer_details'
require 'ebay-trading/types/search_details'
require 'ebay-trading/types/external_product_id'
require 'ebay-trading/types/picture_details'
require 'ebay-trading/types/listing_checkout_redirect_preference'
require 'ebay-trading/types/address'
require 'ebay-trading/types/extended_contact_details'
require 'ebay-trading/types/name_value_list'
require 'ebay-trading/types/buyer_protection_details'
require 'ebay-trading/types/item_policy_violation'
require 'ebay-trading/types/business_seller_details'
require 'ebay-trading/types/buyer_requirement_details'
require 'ebay-trading/types/return_policy'
require 'ebay-trading/types/variations'
require 'ebay-trading/types/item_compatibility_list'
require 'ebay-trading/types/discount_price_info'
require 'ebay-trading/types/quantity_info'
require 'ebay-trading/types/seller_profiles'
require 'ebay-trading/types/shipping_service_cost_override'
require 'ebay-trading/types/ship_package_details'
require 'ebay-trading/types/quantity_restriction_per_buyer_info'
require 'ebay-trading/types/unit_info'
require 'ebay-trading/types/pickup_in_store_details'
