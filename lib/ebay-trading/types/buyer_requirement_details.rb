require 'ebay-trading/types/maximum_item_requirements'
require 'ebay-trading/types/verified_user_requirements'
require 'ebay-trading/types/maximum_unpaid_item_strikes_info'
require 'ebay-trading/types/maximum_buyer_policy_violations'
