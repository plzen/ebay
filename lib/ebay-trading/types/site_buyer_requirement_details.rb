require 'ebay-trading/types/maximum_buyer_policy_violations_details'
require 'ebay-trading/types/maximum_item_requirements_details'
require 'ebay-trading/types/maximum_unpaid_item_strikes_info_details'
require 'ebay-trading/types/minimum_feedback_score_details'
require 'ebay-trading/types/verified_user_requirements_details'
