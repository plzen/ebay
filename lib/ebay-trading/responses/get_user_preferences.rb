require 'ebay-trading/types/bidder_notice_preferences'
require 'ebay-trading/types/combined_payment_preferences'
require 'ebay-trading/types/cross_promotion_preferences'
require 'ebay-trading/types/seller_payment_preferences'
require 'ebay-trading/types/seller_favorite_item_preferences'
require 'ebay-trading/types/end_of_auction_email_preferences'
require 'ebay-trading/types/pro_stores_checkout_preference'
require 'ebay-trading/types/unpaid_item_assistance_preferences'
require 'ebay-trading/types/seller_exclude_ship_to_location_preferences'
require 'ebay-trading/types/purchase_reminder_email_preferences'
require 'ebay-trading/types/seller_profile_preferences'
require 'ebay-trading/types/seller_return_preferences'
require 'ebay-trading/types/dispatch_cutoff_time_preferences'
require 'ebay-trading/types/ebay_plus_preference'
