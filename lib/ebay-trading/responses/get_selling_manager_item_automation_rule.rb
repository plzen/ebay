require 'ebay-trading/types/selling_manager_auto_list'
require 'ebay-trading/types/selling_manager_auto_relist'
require 'ebay-trading/types/selling_manager_auto_second_chance_offer'
require 'ebay-trading/types/fee'
