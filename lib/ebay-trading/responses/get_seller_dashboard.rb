require 'ebay-trading/types/search_standing_dashboard'
require 'ebay-trading/types/seller_fee_discount_dashboard'
require 'ebay-trading/types/power_seller_dashboard'
require 'ebay-trading/types/policy_compliance_dashboard'
require 'ebay-trading/types/buyer_satisfaction_dashboard'
require 'ebay-trading/types/seller_account_dashboard'
require 'ebay-trading/types/performance_dashboard'
