require 'ebay-trading/types/error'
require 'ebay-trading/types/duplicate_invocation_details'
require 'ebay-trading/types/bot_block_response'

module Ebay # :nodoc:
  module Responses # :nodoc:
    # == Attributes
    #  datetime_node :timestamp, 'Timestamp', :optional => true
