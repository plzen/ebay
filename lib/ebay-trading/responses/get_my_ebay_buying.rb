require 'ebay-trading/types/buying_summary'
require 'ebay-trading/types/paginated_item_array'
require 'ebay-trading/types/paginated_order_transaction_array'
require 'ebay-trading/types/my_ebay_favorite_search_list'
require 'ebay-trading/types/my_ebay_favorite_seller_list'
require 'ebay-trading/types/item'
require 'ebay-trading/types/bid_group'
require 'ebay-trading/types/user_defined_list'
