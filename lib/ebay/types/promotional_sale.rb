...
module Ebay # :nodoc:
  module Types # :nodoc:
    ...
    #  text_node :promotional_sale_name, 'PromotionalSaleName', :default_value => ''
    ...
    #  time_node :promotional_sale_start_time, 'PromotionalSaleStartTime', :default_value => ''
    #  time_node :promotional_sale_end_time, 'PromotionalSaleEndTime', :default_value => ''
