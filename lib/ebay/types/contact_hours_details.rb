...
module Ebay # :nodoc:
  module Types # :nodoc:
    ...
    #  hour_node :hours1_from, 'Hours1From', :optional => true
    #  hour_node :hours1_to, 'Hours1To', :optional => true
    #  text_node :hours2_days, 'Hours2Days', :optional => true
    #  boolean_node :hours2_any_time, 'Hours2AnyTime', 'true', 'false', :optional => true
    #  hour_node :hours2_from, 'Hours2From', :optional => true
    #  hour_node :hours2_to, 'Hours2To', :optional => true
