...
module Ebay # :nodoc:
  module Types # :nodoc:
    # == Attributes
    #  text_node :search_name, 'SearchName', :default_value => ''
    #  text_node :search_query, 'SearchQuery', :default_value => ''
    ...
    #  text_node :search_flag, 'SearchFlag', :default_value => ''
    ...
    #  text_node :seller_id, 'SellerID', :default_value => ''
    #  text_node :seller_id_exclude, 'SellerIDExclude', :default_value => ''
