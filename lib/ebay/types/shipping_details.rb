...
module Ebay # :nodoc:
  module Types # :nodoc:
    ...
    #  text_node :payment_instructions, 'PaymentInstructions', :default_value => ''
    #  array_node :sales_taxes, 'SalesTax', :class => SalesTax, :default_value => []
    #  text_node :shipping_rate_error_message, 'ShippingRateErrorMessage', :default_value => ''
    ...
    #  text_node :shipping_discount_profile_id, 'ShippingDiscountProfileID', :default_value => ''
    ...
    #  text_node :international_shipping_discount_profile_id, 'InternationalShippingDiscountProfileID', :default_value => ''
