...
module Ebay # :nodoc:
  module Requests # :nodoc:
    ...
    #  text_node :verify_eligibility_only, 'VerifyEligibilityOnly', :default_value => ''
    #  text_node :recipient_postal_code, 'RecipientPostalCode', :default_value => ''
    ...
    #  text_node :comments, 'Comments', :default_value => ''
